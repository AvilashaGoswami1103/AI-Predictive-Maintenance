...
def calculate_risk(data, is_predicted=False):
    ...
    def forecast_risk(memory_usage):
        ...
        elif memory_usage < 86: return 60
        else: return 100
    ...
    if is_predicted:
        ...
        df['risk_score'] = (
            ...
            0.44 * df['predicted_instant_change'].apply(transition_risk) +
            0.15 * df['predicted_rolling_std_24h'].apply(stability_risk)
        )
    else:
        ...
        df['risk_score'] = (
            ...
            0.42 * df['anomaly_score'].apply(anomaly_risk) +
            0.44 * df['instant_change'].apply(transition_risk) +
